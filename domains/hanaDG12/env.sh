...
##### KHAN [agent] #####
#export AGENT_OPTS="-javaagent:/svc/jdg/ezwel/domains/khan-agent/khan-agent-1.0.0.jar"
#export AGENT_OPTS="$AGENT_OPTS -Dkhan.config.file=khan-agent-ezwelDG12.conf"
